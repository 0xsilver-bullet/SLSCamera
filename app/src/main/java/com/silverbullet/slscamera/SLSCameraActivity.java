package com.silverbullet.slscamera;
...
import com.silverbullet.slscamera.core.AspectFrameLayout;
import com.silverbullet.slscamera.core.CameraUtils;
import com.silverbullet.slscamera.core.FullFrameRect;
import com.silverbullet.slscamera.core.PermissionHelper;
import com.silverbullet.slscamera.core.Texture2dProgram;
import com.silverbullet.slscamera.core.TextureMovieEncoder;
 ...
 */
public class SLSCameraActivity extends AppCompatActivity
        implements SurfaceTexture.OnFrameAvailableListener ,AdapterView.OnItemSelectedListener{
    private static final String TAG = "SLSCameraActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slscamera);
...
//    }
    ...
    static class CameraHandler extends Handler {
        ...
        private WeakReference<SLSCameraActivity> mWeakActivity;

        public CameraHandler(SLSCameraActivity activity) {
            mWeakActivity = new WeakReference<SLSCameraActivity>(activity);
        }
        ...
        public void handleMessage(Message inputMessage) {
            ...
            SLSCameraActivity activity = mWeakActivity.get();
            if (activity == null) {
...
class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    private SLSCameraActivity.CameraHandler mCameraHandler;
     ...
     */
    public CameraSurfaceRenderer(SLSCameraActivity.CameraHandler cameraHandler,
        ...
        mCurrentFilter = -1;
        mNewFilter = SLSCameraActivity.FILTER_NONE;
    }
    ...
    public void updateFilter() {
        ...
        switch (mNewFilter) {
            case SLSCameraActivity.FILTER_NONE:
                programType = Texture2dProgram.ProgramType.TEXTURE_EXT;
                break;
            case SLSCameraActivity.FILTER_BLACK_WHITE:
                // (In a previous version the TEXTURE_EXT_BW variant was enabled by a flag called
                // ROSE_COLORED_GLASSES, because the shader set the red channel to the B&W color
                // and green/blue to zero.)
                programType = Texture2dProgram.ProgramType.TEXTURE_EXT_BW;
                break;
            case SLSCameraActivity.FILTER_BLUR:
                ...
                kernel = new float[] {
                        ...
                        1f/16f, 2f/16f, 1f/16f };
                break;
            case SLSCameraActivity.FILTER_SHARPEN:
                programType = Texture2dProgram.ProgramType.TEXTURE_EXT_FILT;
                kernel = new float[] {
                        0f, -1f, 0f,
                        -1f, 5f, -1f,
                        0f, -1f, 0f };
                break;
            case SLSCameraActivity.FILTER_EDGE_DETECT:
                programType = Texture2dProgram.ProgramType.TEXTURE_EXT_FILT;
                kernel = new float[] {
                        -1f, -1f, -1f,
                        -1f, 8f, -1f,
                        -1f, -1f, -1f };
                break;
            case SLSCameraActivity.FILTER_EMBOSS:
                programType = Texture2dProgram.ProgramType.TEXTURE_EXT_FILT;
                kernel = new float[] {
                        2f, 0f, 0f,
                        0f, -1f, 0f,
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mCameraHandler.sendMessage(mCameraHandler.obtainMessage(
                SLSCameraActivity.CameraHandler.MSG_SET_SURFACE_TEXTURE, mSurfaceTexture));
    }
